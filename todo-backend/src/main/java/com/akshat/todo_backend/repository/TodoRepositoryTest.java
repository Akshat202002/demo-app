...
public class TodoRepositoryTest {
    ...
    public void testFindAll() {
        when(session.createQuery(anyString(), eq(Todo.class))).thenReturn(mock(Query.class));
    ...
    public void testSearchTodos() {
        when(session.createQuery(anyString(), eq(Todo.class))).thenReturn(mock(Query.class));
        when(session.createQuery(anyString(), eq(Todo.class)).setParameter(anyString(), anyString()).list()).thenReturn(Arrays.asList(todo));
